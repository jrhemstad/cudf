...
/* BEGIN: Cython Metadata
{
    "distutils": {
        ...
        "name": "cudf._libxx.utils",
        "sources": [
            "cudf/_libxx/utils.pyx"
        ]
    },
    "module_name": "cudf._libxx.utils"
}
END: Cython Metadata */
...
#define __PYX_HAVE__cudf___libxx__utils
#define __PYX_HAVE_API__cudf___libxx__utils
/* Early includes */
#include "ios"
#include "new"
#include "stdexcept"
...
#define __Pyx_MODULE_NAME "cudf._libxx.utils"
extern int __pyx_module_is_main_cudf___libxx__utils;
int __pyx_module_is_main_cudf___libxx__utils = 0;

/* Implementation of 'cudf._libxx.utils' */
...
static std::vector<cudf::column_view>  __pyx_f_4cudf_6_libxx_5utils_make_column_views(PyObject *__pyx_v_columns) {
  std::vector<cudf::column_view>  __pyx_v_views;
  PyObject *__pyx_v_col = NULL;
  std::vector<cudf::column_view>  __pyx_r;
  ...
  __Pyx_RefNannySetupContext("make_column_views", 0);

  /* "cudf/_libxx/utils.pyx":13
 * cdef vector[column_view] make_column_views(object columns):
 *     cdef vector[column_view] views
 *     views.reserve(len(columns))             # <<<<<<<<<<<<<<
 *     for col in columns:
 ...
 */
  __pyx_t_1 = PyObject_Length(__pyx_v_columns); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 13, __pyx_L1_error)
  __pyx_v_views.reserve(__pyx_t_1);

  /* "cudf/_libxx/utils.pyx":14
 *     cdef vector[column_view] views
 *     views.reserve(len(columns))
 *     for col in columns:             # <<<<<<<<<<<<<<
 *         views.push_back((<Column> col).view())
 ...
 */
  if (likely(PyList_CheckExact(__pyx_v_columns)) || PyTuple_CheckExact(__pyx_v_columns)) {
    __pyx_t_2 = __pyx_v_columns; __Pyx_INCREF(__pyx_t_2); __pyx_t_1 = 0;
    __pyx_t_3 = NULL;
  } else {
    __pyx_t_1 = -1; __pyx_t_2 = PyObject_GetIter(__pyx_v_columns); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 14, __pyx_L1_error)
 ...
 * 
 */
    __pyx_t_5 = ((struct __pyx_vtabstruct_4cudf_6_libxx_6column_Column *)((struct __pyx_obj_4cudf_6_libxx_6column_Column *)__pyx_v_col)->__pyx_vtab)->view(((struct __pyx_obj_4cudf_6_libxx_6column_Column *)__pyx_v_col)); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 15, __pyx_L1_error)
    try {
      __pyx_v_views.push_back(__pyx_t_5);
    } catch(...) {
      __Pyx_CppExn2PyErr();
 ...
 */
  ...
  __Pyx_WriteUnraisable("cudf._libxx.utils.make_column_views", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
...
static std::vector<cudf::table_view>  __pyx_f_4cudf_6_libxx_5utils_make_table_views(PyObject *__pyx_v_tables) {
  std::vector<cudf::table_view>  __pyx_v_views;
  PyObject *__pyx_v_tbl = NULL;
  std::vector<cudf::table_view>  __pyx_r;
  __Pyx_RefNannyDeclarations
  Py_ssize_t __pyx_t_1;
  PyObject *__pyx_t_2 = NULL;
  PyObject *(*__pyx_t_3)(PyObject *);
  ...
  __Pyx_RefNannySetupContext("make_table_views", 0);

  /* "cudf/_libxx/utils.pyx":21
 * cdef vector[table_view] make_table_views(object tables):
 *     cdef vector[table_view] views
 *     views.reserve(len(tables))             # <<<<<<<<<<<<<<
 *     for tbl in tables:
 ...
 */
  __pyx_t_1 = PyObject_Length(__pyx_v_tables); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 21, __pyx_L1_error)
  __pyx_v_views.reserve(__pyx_t_1);

  /* "cudf/_libxx/utils.pyx":22
 *     cdef vector[table_view] views
 *     views.reserve(len(tables))
 *     for tbl in tables:             # <<<<<<<<<<<<<<
 *         views.push_back((<Table> tbl).view())
 ...
 */
  if (likely(PyList_CheckExact(__pyx_v_tables)) || PyTuple_CheckExact(__pyx_v_tables)) {
    ...
    __pyx_t_1 = -1; __pyx_t_2 = PyObject_GetIter(__pyx_v_tables); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 22, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
  ...
  for (;;) {
    ...
    __Pyx_XDECREF_SET(__pyx_v_tbl, __pyx_t_4);
    __pyx_t_4 = 0;

    /* "cudf/_libxx/utils.pyx":23
 *     views.reserve(len(tables))
 *     for tbl in tables:
 *         views.push_back((<Table> tbl).view())             # <<<<<<<<<<<<<<
 *     return views
 * 
 */
    __pyx_t_5 = ((struct __pyx_vtabstruct_4cudf_6_libxx_5table_Table *)((struct __pyx_obj_4cudf_6_libxx_5table_Table *)__pyx_v_tbl)->__pyx_vtab)->view(((struct __pyx_obj_4cudf_6_libxx_5table_Table *)__pyx_v_tbl)); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 23, __pyx_L1_error)
    try {
      __pyx_v_views.push_back(__pyx_t_5);
    } catch(...) {
      __Pyx_CppExn2PyErr();
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_WriteUnraisable("cudf._libxx.utils.make_table_views", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __Pyx_pretend_to_initialize(&__pyx_r);
  __pyx_L0:;
...
static std::vector<cudf::table_view>  __pyx_f_4cudf_6_libxx_5utils_make_table_data_views(PyObject *__pyx_v_tables) {
  std::vector<cudf::table_view>  __pyx_v_views;
  PyObject *__pyx_v_tbl = NULL;
  std::vector<cudf::table_view>  __pyx_r;
  __Pyx_RefNannyDeclarations
  ...
  PyObject *__pyx_t_4 = NULL;
  cudf::table_view __pyx_t_5;
  __Pyx_RefNannySetupContext("make_table_data_views", 0);

  /* "cudf/_libxx/utils.pyx":29
 * cdef vector[table_view] make_table_data_views(object tables):
 *     cdef vector[table_view] views
 *     views.reserve(len(tables))             # <<<<<<<<<<<<<<
 *     for tbl in tables:
 ...
 */
  __pyx_t_1 = PyObject_Length(__pyx_v_tables); if (unlikely(__pyx_t_1 == ((Py_ssize_t)-1))) __PYX_ERR(0, 29, __pyx_L1_error)
  __pyx_v_views.reserve(__pyx_t_1);

  /* "cudf/_libxx/utils.pyx":30
 *     cdef vector[table_view] views
 *     views.reserve(len(tables))
 *     for tbl in tables:             # <<<<<<<<<<<<<<
 *         views.push_back((<Table> tbl).data_view())
 ...
 */
  if (likely(PyList_CheckExact(__pyx_v_tables)) || PyTuple_CheckExact(__pyx_v_tables)) {
    ...
    __pyx_t_1 = -1; __pyx_t_2 = PyObject_GetIter(__pyx_v_tables); if (unlikely(!__pyx_t_2)) __PYX_ERR(0, 30, __pyx_L1_error)
    __Pyx_GOTREF(__pyx_t_2);
    __pyx_t_3 = Py_TYPE(__pyx_t_2)->tp_iternext; if (unlikely(!__pyx_t_3)) __PYX_ERR(0, 30, __pyx_L1_error)
  }
  for (;;) {
    if (likely(!__pyx_t_3)) {
      if (likely(PyList_CheckExact(__pyx_t_2))) {
        if (__pyx_t_1 >= PyList_GET_SIZE(__pyx_t_2)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_4 = PyList_GET_ITEM(__pyx_t_2, __pyx_t_1); __Pyx_INCREF(__pyx_t_4); __pyx_t_1++; if (unlikely(0 < 0)) __PYX_ERR(0, 30, __pyx_L1_error)
        #else
        __pyx_t_4 = PySequence_ITEM(__pyx_t_2, __pyx_t_1); __pyx_t_1++; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 30, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        #endif
      } else {
        if (__pyx_t_1 >= PyTuple_GET_SIZE(__pyx_t_2)) break;
        #if CYTHON_ASSUME_SAFE_MACROS && !CYTHON_AVOID_BORROWED_REFS
        __pyx_t_4 = PyTuple_GET_ITEM(__pyx_t_2, __pyx_t_1); __Pyx_INCREF(__pyx_t_4); __pyx_t_1++; if (unlikely(0 < 0)) __PYX_ERR(0, 30, __pyx_L1_error)
        #else
        __pyx_t_4 = PySequence_ITEM(__pyx_t_2, __pyx_t_1); __pyx_t_1++; if (unlikely(!__pyx_t_4)) __PYX_ERR(0, 30, __pyx_L1_error)
        __Pyx_GOTREF(__pyx_t_4);
        #endif
    ...
    /* "cudf/_libxx/utils.pyx":31
 *     views.reserve(len(tables))
 *     for tbl in tables:
 *         views.push_back((<Table> tbl).data_view())             # <<<<<<<<<<<<<<
 *     return views
 */
    __pyx_t_5 = ((struct __pyx_vtabstruct_4cudf_6_libxx_5table_Table *)((struct __pyx_obj_4cudf_6_libxx_5table_Table *)__pyx_v_tbl)->__pyx_vtab)->data_view(((struct __pyx_obj_4cudf_6_libxx_5table_Table *)__pyx_v_tbl)); if (unlikely(PyErr_Occurred())) __PYX_ERR(0, 31, __pyx_L1_error)
    try {
      __pyx_v_views.push_back(__pyx_t_5);
    } catch(...) {
      __Pyx_CppExn2PyErr();
 ...
 */
  ...
  __Pyx_XDECREF(__pyx_t_2);
  __Pyx_XDECREF(__pyx_t_4);
  __Pyx_WriteUnraisable("cudf._libxx.utils.make_table_data_views", __pyx_clineno, __pyx_lineno, __pyx_filename, 1, 0);
  __Pyx_pretend_to_initialize(&__pyx_r);
  __pyx_L0:;
  __Pyx_XDECREF(__pyx_v_tbl);
  __Pyx_RefNannyFinishContext();
...
static PyTypeObject __pyx_type___pyx_array = {
  ...
  "cudf._libxx.utils.array", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_MemviewEnum = {
  PyVarObject_HEAD_INIT(0, 0)
  "cudf._libxx.utils.Enum", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryview = {
  PyVarObject_HEAD_INIT(0, 0)
  "cudf._libxx.utils.memoryview", /*tp_name*/
...
static PyTypeObject __pyx_type___pyx_memoryviewslice = {
  PyVarObject_HEAD_INIT(0, 0)
  "cudf._libxx.utils._memoryviewslice", /*tp_name*/
...
static int __Pyx_modinit_function_export_code(void) {
  ...
  if (__Pyx_ExportFunction("make_column_views", (void (*)(void))__pyx_f_4cudf_6_libxx_5utils_make_column_views, "std::vector<cudf::column_view>  (PyObject *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("make_table_views", (void (*)(void))__pyx_f_4cudf_6_libxx_5utils_make_table_views, "std::vector<cudf::table_view>  (PyObject *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  if (__Pyx_ExportFunction("make_table_data_views", (void (*)(void))__pyx_f_4cudf_6_libxx_5utils_make_table_data_views, "std::vector<cudf::table_view>  (PyObject *)") < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_cudf___libxx__utils) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name_2, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "cudf._libxx.utils")) {
      if (unlikely(PyDict_SetItemString(modules, "cudf._libxx.utils", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init cudf._libxx.utils", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init cudf._libxx.utils");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
